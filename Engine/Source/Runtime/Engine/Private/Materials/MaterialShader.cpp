...
FString GetShadingModelString(EMaterialShadingModel ShadingModel)
{
	...
	switch(ShadingModel)
	{
		...
		case MSM_DoubleLayerWater:	ShadingModelName = TEXT("MSM_DoubleLayerWater"); break;
...
void UpdateMaterialShaderCompilingStats(const FMaterial* Material)
{
	...
	else if (ShadingModels.HasAnyShadingModel({ MSM_DefaultLit, MSM_Subsurface, MSM_PreintegratedSkin, MSM_ClearCoat, MSM_Cloth, MSM_SubsurfaceProfile, MSM_TwoSidedFoliage, MSM_SingleLayerWater, MSM_DoubleLayerWater, MSM_ThinTranslucent }))
	{
